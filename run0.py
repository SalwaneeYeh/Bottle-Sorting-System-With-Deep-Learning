...
# ===== CONFIG =====
model_path = "/home/project/model-finaluse/model-finaluse.tflite" #path model
labels = ['cans', 'glass', 'other', 'plastic'] #จัดเรียงลำดับตามไฟล์ labels.txt
input_size = 224 #ขนาดภาพ
num_images = 3
serial_port = "/dev/ttyUSB0" #พอร์ต USB Webcam
baud_rate = 9600 
...
try:
    while True:
        ...
        for i in range(num_images):
            ...
            cv2.putText(frame, f"Prediction: {label} ({conf*100:.1f}%)", (10,30),
